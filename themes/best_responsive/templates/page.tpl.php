...
<div id="wrap" class="clearfix">
  ...
  <div id="copyright">
    <?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <a href="<?php print $front_page; ?>"><?php print $site_name; ?></a>. <?php print t('Developed by'); ?>  <a href="http://www.iifancy.com" target="_blank">Iifancy</a>
  </div>
</div>